...
| Admin | human | Registry-only authority — manages who holds what role (add/remove operators, set oracle, pause trading, two-step admin transfer) | Cannot directly call user-facing functions; registry-only; two-step transfer for admin role |
